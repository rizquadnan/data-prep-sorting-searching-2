...
void insertionSortDn(vector<string> arr, int n)
{
    string key;
    int i, j;
...
void driver(string inFile)
{
    ...
    for (size_t looper = 0; looper < isaSize; looper++)
    {
      insertionSortDn(indexedSortingArray[looper].stringValues, indexedSortingArray[looper].stringValues.size());
    } 
    ...
    insertionSort(resultArr, arrSize);
